...
#define uart_rxp_wrap_target 0
#define uart_rxp_wrap 9
#define uart_rxp_pio_version 1

static const uint16_t uart_rxp_program_instructions[] = {
            //     .wrap_target
    0x2020, //  0: wait   0 pin, 0                   
    0xea28, //  1: set    x, 8                   [10]
    0x4001, //  2: in     pins, 1                    
...
#if !PICO_NO_HARDWARE
static const struct pio_program uart_rxp_program = {
    .instructions = uart_rxp_program_instructions,
    .length = 10,
    .origin = -1,
    .pio_version = uart_rxp_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};

static inline pio_sm_config uart_rxp_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + uart_rxp_wrap_target, offset + uart_rxp_wrap);
    return c;
}
...
static inline char uart_rx_program_getc(PIO pio, uint sm) {
    ...
    io_rw_8 *rxfifo_shift = (io_rw_8*)&pio->rxf[sm];
